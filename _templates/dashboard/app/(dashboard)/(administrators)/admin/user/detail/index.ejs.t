---
to: src/app/(dashboard)/(administrators)/admin/user/detail/index.tsx
---
'use client'
...
const AdminUserDetail: FC<any> = function ({ adminUser }) {
  return (
    <>
      <div className="mb-4 grid grid-cols-1 gap-y-6 p-4 xl:gap-4 dark:border-gray-700 dark:bg-gray-900">
        <div className="col-span-full xl:mb-2">
          <Breadcrumb className="mb-5">
            ...
            <Breadcrumb.Item>{adminUser.id}</Breadcrumb.Item>
          </Breadcrumb>
        ...
        <div className="grid grid-cols-1 gap-y-4 px-4">
          <ContentForm adminUser={adminUser} />
        </div>
      </div>
    </>
  )
