---
to: src/app/(dashboard)/(administrators)/admin/user/index.tsx
---
'use client'
...
const AdminUsers: FC<any> = function ({ adminUsers, metadata, setMetadata }) {
  return (
    <>
        ...
        <div className="mb-1 w-full">
          ...
          <div className="flex flex-wrap items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-4 sm:justify-end">
              ...
              <Button color="primary" href="/admin/user/add">
        ...
        <div>
          <div className="min-w-full overflow-x-auto align-middle">
            <div className="xs:max-h-[calc(100vh-334px)] max-h-[calc(100vh-290px)] overflow-y-auto shadow sm:max-h-[calc(100vh-254px)] md:max-h-[calc(100vh-254px)] lg:max-h-[calc(100vh-254px)]">
              <TableList adminUsers={adminUsers} />
            </div>
          </div>
        </div>
      </div>
